...
var codecVarints = require('multicodec/src/varint-table');
  ...
  _createClass(CID, [{
    ...
    get: function get() {
      switch (this.version) {
        ...
        case 1:
          return Buffer.concat([Buffer('01', 'hex'), Buffer(codecVarints[this.codec]), this.multihash]);
        default:
          throw new Error('unsupported version');
      }
    }
    ...
    key: 'prefix',
    get: function get() {
      return Buffer.concat([new Buffer('0' + this.version, 'hex'), codecVarints[this.codec], multihash.prefix(this.multihash)]);
    }
  }], [{
    key: 'isCID',
    value: function isCID(other) {
      try {
