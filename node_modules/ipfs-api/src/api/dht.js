...
module.exports = function (send) {
  return {
    ...
    findprovs: promisify(function (cid, opts, callback) {
      if (typeof opts === 'function' && !callback) {
        callback = opts;
        opts = {};
      }
    ...
    findpeer: promisify(function (peerId, opts, callback) {
      if (typeof opts === 'function' && !callback) {
        callback = opts;
        opts = {};
      }
    ...
    provide: promisify(function (cids, opts, callback) {
      if (typeof opts === 'function' && !callback) {
        callback = opts;
        opts = {};
      }
    ...
    query: promisify(function (peerId, opts, callback) {
      if (typeof opts === 'function' && !callback) {
        callback = opts;
        opts = {};
      }
