...
exports.unmarshalPrivateKey = function (key, callback) {
  var privateKey = crypto.subtle.importKey('jwk', key, {
    name: 'RSASSA-PKCS1-v1_5',
    hash: { name: 'SHA-256' }
  }, true, ['sign']);
...
exports.hashAndSign = function (key, msg, callback) {
  nodeify(crypto.subtle.importKey('jwk', key, {
    name: 'RSASSA-PKCS1-v1_5',
    hash: { name: 'SHA-256' }
  }, false, ['sign']).then(function (privateKey) {
    return crypto.subtle.sign({ name: 'RSASSA-PKCS1-v1_5' }, privateKey, Uint8Array.from(msg));
  }).then(function (sig) {
...
exports.hashAndVerify = function (key, sig, msg, callback) {
  nodeify(crypto.subtle.importKey('jwk', key, {
    ...
    return crypto.subtle.verify({ name: 'RSASSA-PKCS1-v1_5' }, publicKey, sig, msg);
  }), callback);
};
